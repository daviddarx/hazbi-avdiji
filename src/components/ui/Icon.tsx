...
export default function Icon({
  ...
  name: 'close' | 'light' | 'dark' | 'system' | 'menu' | 'arrow';
  className?: string;
}) {
  return (
    <svg
      ...
      fill='none'
      viewBox={name === 'arrow' ? '0 0 40 24' : '0 0 24 24'}
      className={classNames('h-24', name === 'arrow' ? 'w-40' : 'w-24', className)}
    >
      {name === 'close' && (
        <path
          stroke='currentColor'
